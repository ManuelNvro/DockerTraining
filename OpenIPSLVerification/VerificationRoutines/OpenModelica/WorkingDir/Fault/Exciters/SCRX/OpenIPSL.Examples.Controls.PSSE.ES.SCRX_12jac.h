...
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_NLSJac43 0
  int OpenIPSL_Examples_Controls_PSSE_ES_SCRX_functionJacNLSJac43_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int OpenIPSL_Examples_Controls_PSSE_ES_SCRX_initialAnalyticJacobianNLSJac43(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_F 1
  int OpenIPSL_Examples_Controls_PSSE_ES_SCRX_functionJacF_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int OpenIPSL_Examples_Controls_PSSE_ES_SCRX_initialAnalyticJacobianF(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_D 2
...
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_C 3
...
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_B 4
...
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_A 5
