...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_408(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = DIVISION((data->localData[0]->realVars[130] /* pwLine1.vs.re variable */) * (jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) + (data->localData[0]->realVars[129] /* pwLine1.vs.im variable */) * (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */),sqrt((tmp0 * tmp0) + (tmp1 * tmp1)),"sqrt(pwLine1.vs.re ^ 2.0 + pwLine1.vs.im ^ 2.0)");
  TRACE_POP
}
...
equation index: 409
type: SIMPLE_ASSIGN
constantLoad.kI.$pDERNLSJac9.dummyVarNLSJac9 = if constantLoad.v < 0.5 then constantLoad.a2 * constantLoad.b2 * (constantLoad.v ^ (-1.0 + constantLoad.b2) * (-exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) * constantLoad.a2 * constantLoad.b2 * constantLoad.v ^ (constantLoad.b2 - 1.0) * constantLoad.v.$pDERNLSJac9.dummyVarNLSJac9 + (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (-1.0 + constantLoad.b2 - 1.0) * (-1.0 + constantLoad.b2) * constantLoad.v.$pDERNLSJac9.dummyVarNLSJac9) * exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) else 0.0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_409(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp41)
  {
    ...
    else
    {
      ...
      tmp33 = (tmp27) * ((-1.0 + data->simulationInfo->realParameter[68] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */));
    }
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_413(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* gENROE.PSId.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[260] /* gENROE.Xppd PARAM */)) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac9 SEED_VAR */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_414(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[31] /* $cse7 variable */) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac9 SEED_VAR */) + (data->localData[0]->realVars[30] /* $cse6 variable */) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[206] /* gENROE.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_415(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[30] /* $cse6 variable */) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac9 SEED_VAR */) - ((data->localData[0]->realVars[31] /* $cse7 variable */) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac9 SEED_VAR */))) * (data->simulationInfo->realParameter[206] /* gENROE.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_416(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = jacobian->tmpVars[5] /* gENROE.PSId.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[243] /* gENROE.R_a PARAM */) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac9 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_417(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[9] /* gENROE.PSIq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[261] /* gENROE.Xppq PARAM */)) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac9 SEED_VAR */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_418(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[9] /* gENROE.PSIq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) - ((data->simulationInfo->realParameter[243] /* gENROE.R_a PARAM */) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac9 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_419(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[30] /* $cse6 variable */) * (jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) + (data->localData[0]->realVars[31] /* $cse7 variable */) * (jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_420(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[30] /* $cse6 variable */) * (jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) - ((data->localData[0]->realVars[31] /* $cse7 variable */) * (jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_421(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[13] /* gENCLS.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (((-data->localData[0]->realVars[26] /* $cse1 variable */)) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac9 SEED_VAR */) - ((data->localData[0]->realVars[27] /* $cse2 variable */) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac9 SEED_VAR */))) * (data->simulationInfo->realParameter[180] /* gENCLS.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_422(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[14] /* gENCLS.p.ii.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[27] /* $cse2 variable */) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac9 SEED_VAR */) - ((data->localData[0]->realVars[26] /* $cse1 variable */) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac9 SEED_VAR */))) * (data->simulationInfo->realParameter[180] /* gENCLS.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_423(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[186] /* gENCLS.R_a PARAM */)) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac9 SEED_VAR */) - ((data->simulationInfo->realParameter[189] /* gENCLS.X_d PARAM */) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac9 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_424(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[189] /* gENCLS.X_d PARAM */) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac9 SEED_VAR */) - ((data->simulationInfo->realParameter[186] /* gENCLS.R_a PARAM */) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac9 SEED_VAR */));
  TRACE_POP
}
...
equation index: 425
type: SIMPLE_ASSIGN
pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 = (-pwLine1.ir.re.SeedNLSJac9) - gENCLS.p.ir.$pDERNLSJac9.dummyVarNLSJac9
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_425(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[17] /* pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[11] /* pwLine1.ir.re.SeedNLSJac9 SEED_VAR */) - jacobian->tmpVars[13] /* gENCLS.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 426
type: SIMPLE_ASSIGN
pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 = (-pwLine1.ir.im.SeedNLSJac9) - gENCLS.p.ii.$pDERNLSJac9.dummyVarNLSJac9
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_426(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[18] /* pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[10] /* pwLine1.ir.im.SeedNLSJac9 SEED_VAR */) - jacobian->tmpVars[14] /* gENCLS.p.ii.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_427(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac9 SEED_VAR */) - jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac9 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_428(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac9 SEED_VAR */) - jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac9 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_429(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[21] /* constantLoad.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac9 SEED_VAR */) - jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[8] /* pwLine3.is.re.SeedNLSJac9 SEED_VAR */;
  TRACE_POP
}
...
equation index: 430
type: SIMPLE_ASSIGN
pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 = (-pwLine1.is.im.SeedNLSJac9) - pwLine3.is.im.SeedNLSJac9 - constantLoad.p.ii.SeedNLSJac9
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_430(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[22] /* pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac9 SEED_VAR */) - jacobian->seedVars[9] /* pwLine3.is.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[1] /* constantLoad.p.ii.SeedNLSJac9 SEED_VAR */;
  TRACE_POP
}
...
equation index: 431
type: SIMPLE_ASSIGN
$res_NLSJac9_1.$pDERNLSJac9.dummyVarNLSJac9 = $cse2 * gENCLS.vq.$pDERNLSJac9.dummyVarNLSJac9 + $cse1 * gENCLS.vd.$pDERNLSJac9.dummyVarNLSJac9 - pwLine1.vr.re.SeedNLSJac9
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_432(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[1] /* $res_NLSJac9_2.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp48 && tmp49)?jacobian->seedVars[9] /* pwLine3.is.im.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[325] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[9] /* pwLine3.is.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[324] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[8] /* pwLine3.is.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */)))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_433(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[2] /* $res_NLSJac9_3.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp50 && tmp51)?jacobian->seedVars[8] /* pwLine3.is.re.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[325] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[8] /* pwLine3.is.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[324] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[9] /* pwLine3.is.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_434(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp64)
  {
    tmp65 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp62)
    {
      tmp63 = jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp60)
      {
        ...
        tmp61 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[291] /* pwFault.R PARAM */) * (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) - ((data->simulationInfo->realParameter[292] /* pwFault.X PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */))) * ((tmp55 * tmp55) + (tmp56 * tmp56)),(tmp59 * tmp59),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp61 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
      }
      tmp63 = tmp61;
    }
    tmp65 = tmp63;
  }
  jacobian->resultVars[3] /* $res_NLSJac9_4.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = tmp65;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_435(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[4] /* $res_NLSJac9_5.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp66 && tmp67)?jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[336] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[335] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_436(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[5] /* $res_NLSJac9_6.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp68 && tmp69)?jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[336] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[335] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 437
type: SIMPLE_ASSIGN
$res_NLSJac9_7.$pDERNLSJac9.dummyVarNLSJac9 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.ir.re.SeedNLSJac9 else pwLine1.vr.re.SeedNLSJac9 - pwLine1.vs.re.SeedNLSJac9 - (pwLine1.Z.re * (pwLine1.ir.re.SeedNLSJac9 + pwLine1.vr.im.SeedNLSJac9 * pwLine1.Y.im - pwLine1.vr.re.SeedNLSJac9 * pwLine1.Y.re) - pwLine1.Z.im * (pwLine1.ir.im.SeedNLSJac9 + (-pwLine1.vr.re.SeedNLSJac9) * pwLine1.Y.im - pwLine1.vr.im.SeedNLSJac9 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_437(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[6] /* $res_NLSJac9_7.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp70 && tmp71)?jacobian->seedVars[11] /* pwLine1.ir.re.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[314] /* pwLine1.Z.re PARAM */) * (jacobian->seedVars[11] /* pwLine1.ir.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[313] /* pwLine1.Z.im PARAM */) * (jacobian->seedVars[10] /* pwLine1.ir.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 438
type: SIMPLE_ASSIGN
$res_NLSJac9_8.$pDERNLSJac9.dummyVarNLSJac9 = if time >= pwLine4.t1 and time < pwLine4.t2 then pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 else pwLine1.vr.re.SeedNLSJac9 - pwLine3.vr.re.SeedNLSJac9 - (pwLine4.Z.re * (pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 + pwLine1.vr.im.SeedNLSJac9 * pwLine4.Y.im - pwLine1.vr.re.SeedNLSJac9 * pwLine4.Y.re) - pwLine4.Z.im * (pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 + (-pwLine1.vr.re.SeedNLSJac9) * pwLine4.Y.im - pwLine1.vr.im.SeedNLSJac9 * pwLine4.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_438(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[7] /* $res_NLSJac9_8.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp72 && tmp73)?jacobian->tmpVars[17] /* pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */:jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[336] /* pwLine4.Z.re PARAM */) * (jacobian->tmpVars[17] /* pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[335] /* pwLine4.Z.im PARAM */) * (jacobian->tmpVars[18] /* pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 439
type: SIMPLE_ASSIGN
$res_NLSJac9_9.$pDERNLSJac9.dummyVarNLSJac9 = if time >= pwLine4.t1 and time < pwLine4.t2 then pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 else pwLine1.vr.im.SeedNLSJac9 - pwLine3.vr.im.SeedNLSJac9 - (pwLine4.Z.re * (pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 + (-pwLine1.vr.re.SeedNLSJac9) * pwLine4.Y.im - pwLine1.vr.im.SeedNLSJac9 * pwLine4.Y.re) + pwLine4.Z.im * (pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 + pwLine1.vr.im.SeedNLSJac9 * pwLine4.Y.im - pwLine1.vr.re.SeedNLSJac9 * pwLine4.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_439(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[8] /* $res_NLSJac9_9.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp74 && tmp75)?jacobian->tmpVars[18] /* pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */:jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[336] /* pwLine4.Z.re PARAM */) * (jacobian->tmpVars[18] /* pwLine4.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[335] /* pwLine4.Z.im PARAM */) * (jacobian->tmpVars[17] /* pwLine4.ir.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[333] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[334] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_440(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp88)
  {
    tmp89 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp86)
    {
      tmp87 = jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp84)
      {
        ...
        tmp85 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[291] /* pwFault.R PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */) + (data->simulationInfo->realParameter[292] /* pwFault.X PARAM */) * (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */)) * ((tmp79 * tmp79) + (tmp80 * tmp80)),(tmp83 * tmp83),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp85 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
      }
      tmp87 = tmp85;
    }
    tmp89 = tmp87;
  }
  jacobian->resultVars[9] /* $res_NLSJac9_10.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = tmp89;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_441(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[10] /* $res_NLSJac9_11.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp90 && tmp91)?jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[325] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[324] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_442(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[11] /* $res_NLSJac9_12.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp92 && tmp93)?jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[325] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[324] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[322] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[323] /* pwLine3.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 443
type: SIMPLE_ASSIGN
$res_NLSJac9_13.$pDERNLSJac9.dummyVarNLSJac9 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 else pwLine1.vs.im.SeedNLSJac9 - pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 - (pwLine.Z.re * (pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 + (-pwLine1.vs.re.SeedNLSJac9) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac9 * pwLine.Y.re) + pwLine.Z.im * (pwLine.ir.re.SeedNLSJac9 + pwLine1.vs.im.SeedNLSJac9 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac9 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_443(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[12] /* $res_NLSJac9_13.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp94 && tmp95)?jacobian->tmpVars[22] /* pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */:jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */ - jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[303] /* pwLine.Z.re PARAM */) * (jacobian->tmpVars[22] /* pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */))) + (data->simulationInfo->realParameter[302] /* pwLine.Z.im PARAM */) * (jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 444
type: SIMPLE_ASSIGN
$res_NLSJac9_14.$pDERNLSJac9.dummyVarNLSJac9 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.re.SeedNLSJac9 else pwLine1.vs.re.SeedNLSJac9 - pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 - (pwLine.Z.re * (pwLine.ir.re.SeedNLSJac9 + pwLine1.vs.im.SeedNLSJac9 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac9 * pwLine.Y.re) - pwLine.Z.im * (pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 + (-pwLine1.vs.re.SeedNLSJac9) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac9 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_444(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[13] /* $res_NLSJac9_14.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp96 && tmp97)?jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */ - jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[303] /* pwLine.Z.re PARAM */) * (jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[302] /* pwLine.Z.im PARAM */) * (jacobian->tmpVars[22] /* pwLine.ir.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_445(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[14] /* $res_NLSJac9_15.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp98 && tmp99)?jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[303] /* pwLine.Z.re PARAM */) * (jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + (jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[302] /* pwLine.Z.im PARAM */) * (jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + ((-jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */)) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_446(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[15] /* $res_NLSJac9_16.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp100 && tmp101)?jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[303] /* pwLine.Z.re PARAM */) * (jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + ((-jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */)) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */))) + (data->simulationInfo->realParameter[302] /* pwLine.Z.im PARAM */) * (jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ + (jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[300] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[301] /* pwLine.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 447
type: SIMPLE_ASSIGN
$res_NLSJac9_17.$pDERNLSJac9.dummyVarNLSJac9 = pwLine1.vs.im * constantLoad.p.ii.SeedNLSJac9 + pwLine1.vs.im.SeedNLSJac9 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.$pDERNLSJac9.dummyVarNLSJac9 + pwLine1.vs.re.SeedNLSJac9 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac9.dummyVarNLSJac9
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_447(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[16] /* $res_NLSJac9_17.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = (data->localData[0]->realVars[129] /* pwLine1.vs.im variable */) * (jacobian->seedVars[1] /* constantLoad.p.ii.SeedNLSJac9 SEED_VAR */) + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->localData[0]->realVars[53] /* constantLoad.p.ii variable */) + (data->localData[0]->realVars[130] /* pwLine1.vs.re variable */) * (jacobian->tmpVars[21] /* constantLoad.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->localData[0]->realVars[54] /* constantLoad.p.ir variable */) - jacobian->tmpVars[4] /* constantLoad.P.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 448
type: SIMPLE_ASSIGN
$res_NLSJac9_18.$pDERNLSJac9.dummyVarNLSJac9 = pwLine1.vs.im * constantLoad.p.ir.$pDERNLSJac9.dummyVarNLSJac9 + pwLine1.vs.im.SeedNLSJac9 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac9) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac9.dummyVarNLSJac9 - pwLine1.vs.re * constantLoad.p.ii.SeedNLSJac9
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_448(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[17] /* $res_NLSJac9_18.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = (data->localData[0]->realVars[129] /* pwLine1.vs.im variable */) * (jacobian->tmpVars[21] /* constantLoad.p.ir.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->localData[0]->realVars[54] /* constantLoad.p.ir variable */) + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->localData[0]->realVars[53] /* constantLoad.p.ii variable */) - jacobian->tmpVars[3] /* constantLoad.Q.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */ - ((data->localData[0]->realVars[130] /* pwLine1.vs.re variable */) * (jacobian->seedVars[1] /* constantLoad.p.ii.SeedNLSJac9 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_449(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[18] /* $res_NLSJac9_19.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp102 && tmp103)?jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[314] /* pwLine1.Z.re PARAM */) * (jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */))) + (data->simulationInfo->realParameter[313] /* pwLine1.Z.im PARAM */) * (jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */)))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_450(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[19] /* $res_NLSJac9_20.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp104 && tmp105)?jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[314] /* pwLine1.Z.re PARAM */) * (jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[313] /* pwLine1.Z.im PARAM */) * (jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 451
type: SIMPLE_ASSIGN
$res_NLSJac9_21.$pDERNLSJac9.dummyVarNLSJac9 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.ir.im.SeedNLSJac9 else pwLine1.vr.im.SeedNLSJac9 - pwLine1.vs.im.SeedNLSJac9 - (pwLine1.Z.re * (pwLine1.ir.im.SeedNLSJac9 + (-pwLine1.vr.re.SeedNLSJac9) * pwLine1.Y.im - pwLine1.vr.im.SeedNLSJac9 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.ir.re.SeedNLSJac9 + pwLine1.vr.im.SeedNLSJac9 * pwLine1.Y.im - pwLine1.vr.re.SeedNLSJac9 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_451(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[20] /* $res_NLSJac9_21.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = ((tmp106 && tmp107)?jacobian->seedVars[10] /* pwLine1.ir.im.SeedNLSJac9 SEED_VAR */:jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac9 SEED_VAR */ - ((data->simulationInfo->realParameter[314] /* pwLine1.Z.re PARAM */) * (jacobian->seedVars[10] /* pwLine1.ir.im.SeedNLSJac9 SEED_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */)) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */))) + (data->simulationInfo->realParameter[313] /* pwLine1.Z.im PARAM */) * (jacobian->seedVars[11] /* pwLine1.ir.re.SeedNLSJac9 SEED_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[311] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac9 SEED_VAR */) * (data->simulationInfo->realParameter[312] /* pwLine1.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 452
type: SIMPLE_ASSIGN
$res_NLSJac9_22.$pDERNLSJac9.dummyVarNLSJac9 = $cse1 * gENCLS.vq.$pDERNLSJac9.dummyVarNLSJac9 + (-$cse2) * gENCLS.vd.$pDERNLSJac9.dummyVarNLSJac9 - pwLine1.vr.im.SeedNLSJac9
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_eqFunction_452(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[21] /* $res_NLSJac9_22.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_VAR */ = (data->localData[0]->realVars[26] /* $cse1 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) + ((-data->localData[0]->realVars[27] /* $cse2 variable */)) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac9.dummyVarNLSJac9 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac9 SEED_VAR */;
  TRACE_POP
}

OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_functionJacNLSJac9_constantEqns(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH

  DATA* data = ((DATA*)inData);
  int index = OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_INDEX_JAC_NLSJac9;
...
int OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_functionJacNLSJac9_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH
...
OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_initialAnalyticJacobianNLSJac9(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian)
{
  TRACE_PUSH
  DATA* data = ((DATA*)inData);
