...
eqns: {179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 223, 222, 221, 220, 219, 218, 217, 216, 215, 214, 213, 212, 211, 210, 209, 208, 207, 206, 205, 204, 203, 202}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_IEEET2_eqFunction_269(DATA *data, threadData_t *threadData)
{
  ...
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 269 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  if (retValue > 0){
    const int indexes[2] = {1,269};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 269 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
void OpenIPSL_Examples_Controls_PSSE_ES_IEEET2_eqFunction_299(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 299 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,299};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 299 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
void OpenIPSL_Examples_Controls_PSSE_ES_IEEET2_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{7aca74fd-fb8a-4e36-88f8-27366f9694d0}";
  ...
  data->modelData->modelDataXml.nEquations = 583;
