...
extern void OpenIPSL_Examples_Controls_PSSE_ES_IEEET1_eqFunction_329(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_IEEET1_eqFunction_163(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_IEEET1_eqFunction_330(DATA* data, threadData_t *threadData);
...
int OpenIPSL_Examples_Controls_PSSE_ES_IEEET1_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  OpenIPSL_Examples_Controls_PSSE_ES_IEEET1_function_savePreSynchronous(data, threadData);
