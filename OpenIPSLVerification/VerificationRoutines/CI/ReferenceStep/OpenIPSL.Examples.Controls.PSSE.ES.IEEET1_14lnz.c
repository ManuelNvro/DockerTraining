...
{
  return "model linearized_model \"OpenIPSL_Examples_Controls_PSSE_ES_IEEET1\" \n  parameter Integer n = 12 \"number of states\";\n  parameter Integer m = 0 \"number of inputs\";\n  parameter Integer p = 0 \"number of outputs\";\n"
