...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_145(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[126] /* sEXS.EFD0 variable */ = data->simulationInfo->realParameter[174] /* gENROU.efd0 PARAM */;
  TRACE_POP
}
/*
equation index: 146
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_148(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[67] /* gENROU.PSIppd variable */ = (data->localData[0]->realVars[3] /* gENROU.Epq STATE(1) */) * (data->simulationInfo->realParameter[122] /* gENROU.K3d PARAM */) + (data->localData[0]->realVars[4] /* gENROU.PSIkd STATE(1) */) * (data->simulationInfo->realParameter[124] /* gENROU.K4d PARAM */);
  TRACE_POP
}
/*
equation index: 149
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_149(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[68] /* gENROU.PSIppq variable */ = (data->localData[0]->realVars[5] /* gENROU.PSIkq STATE(1) */) * (data->simulationInfo->realParameter[125] /* gENROU.K4q PARAM */) + (data->localData[0]->realVars[2] /* gENROU.Epd STATE(1) */) * (data->simulationInfo->realParameter[123] /* gENROU.K3q PARAM */);
  TRACE_POP
}
/*
equation index: 150
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_151(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[23] /* $cse5 variable */ = omc_OpenIPSL_NonElectrical_Functions_SE(threadData, data->localData[0]->realVars[66] /* gENROU.PSIpp variable */, data->simulationInfo->realParameter[144] /* gENROU.S10 PARAM */, data->simulationInfo->realParameter[145] /* gENROU.S12 PARAM */, 1.0, 1.2);
  TRACE_POP
}
/*
equation index: 152
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_152(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[16] /* der(gENROU.delta) STATE_DER */ = (data->simulationInfo->realParameter[188] /* gENROU.w_b PARAM */) * (data->localData[0]->realVars[7] /* gENROU.w STATE(1) */);
  TRACE_POP
}
/*
equation index: 153
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_153(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->timeValue, data->simulationInfo->realParameter[263] /* sEXS.Vref_step.startTime PARAM */, 0, Less);
  data->localData[0]->realVars[128] /* sEXS.Vref_step.y variable */ = data->simulationInfo->realParameter[262] /* sEXS.Vref_step.offset PARAM */ + (tmp2?0.0:data->simulationInfo->realParameter[261] /* sEXS.Vref_step.height PARAM */);
  TRACE_POP
}
/*
equation index: 154
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_155(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[129] /* sEXS.leadLag.TF.x[1] variable */ = DIVISION_SIM(data->localData[0]->realVars[8] /* sEXS.leadLag.TF.x_scaled[1] STATE(1) */,data->simulationInfo->realParameter[274] /* sEXS.leadLag.TF.a_end PARAM */,"sEXS.leadLag.TF.a_end",equationIndexes);
  TRACE_POP
}
/*
equation index: 156
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_204(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_203(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_202(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_201(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_200(DATA*, threadData_t*);
...
vars: {pwLine4.is.im, pwLine3.ir.im, pwLine3.is.re, constantLoad.p.ir, pwLine3.is.im, constantLoad.p.ii, pwLine4.is.re, pwLine3.ir.re, pwLine1.is.re, pwLine1.is.im, pwLine4.ir.re, pwLine1.ir.im, gENCLS.iq, gENCLS.id, pwLine1.vr.im, pwLine1.vr.re, gENROU.id, gENROU.iq, pwLine3.vr.re, pwLine1.vs.im, pwLine1.vs.re, pwLine3.vr.im}
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_250(DATA *data, threadData_t *threadData)
{
  ...
  /* get old value */
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[0] = data->localData[0]->realVars[120] /* pwLine4.is.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[1] = data->localData[0]->realVars[108] /* pwLine3.ir.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[111] /* pwLine3.is.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[48] /* constantLoad.p.ir variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[110] /* pwLine3.is.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[5] = data->localData[0]->realVars[47] /* constantLoad.p.ii variable */;
  ...
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[8] = data->localData[0]->realVars[99] /* pwLine1.is.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[9] = data->localData[0]->realVars[98] /* pwLine1.is.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[10] = data->localData[0]->realVars[119] /* pwLine4.ir.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[11] = data->localData[0]->realVars[96] /* pwLine1.ir.im variable */;
  ...
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[14] = data->localData[0]->realVars[100] /* pwLine1.vr.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[15] = data->localData[0]->realVars[101] /* pwLine1.vr.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[16] = data->localData[0]->realVars[76] /* gENROU.id variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[17] = data->localData[0]->realVars[77] /* gENROU.iq variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[18] = data->localData[0]->realVars[113] /* pwLine3.vr.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[19] = data->localData[0]->realVars[102] /* pwLine1.vs.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[20] = data->localData[0]->realVars[103] /* pwLine1.vs.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[21] = data->localData[0]->realVars[112] /* pwLine3.vr.im variable */;
  ...
  /* write solution */
  data->localData[0]->realVars[120] /* pwLine4.is.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[0];
  data->localData[0]->realVars[108] /* pwLine3.ir.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[1];
  data->localData[0]->realVars[111] /* pwLine3.is.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[48] /* constantLoad.p.ir variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[110] /* pwLine3.is.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  data->localData[0]->realVars[47] /* constantLoad.p.ii variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[5];
  ...
  data->localData[0]->realVars[99] /* pwLine1.is.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[8];
  data->localData[0]->realVars[98] /* pwLine1.is.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[9];
  data->localData[0]->realVars[119] /* pwLine4.ir.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[10];
  data->localData[0]->realVars[96] /* pwLine1.ir.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[11];
  ...
  data->localData[0]->realVars[100] /* pwLine1.vr.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[14];
  data->localData[0]->realVars[101] /* pwLine1.vr.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[15];
  data->localData[0]->realVars[76] /* gENROU.id variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[16];
  data->localData[0]->realVars[77] /* gENROU.iq variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[17];
  data->localData[0]->realVars[113] /* pwLine3.vr.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[18];
  data->localData[0]->realVars[102] /* pwLine1.vs.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[19];
  data->localData[0]->realVars[103] /* pwLine1.vs.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[20];
  data->localData[0]->realVars[112] /* pwLine3.vr.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[21];
  TRACE_POP
}
/*
equation index: 251
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_256(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[17] /* der(gENROU.w) STATE_DER */ = (0.5) * (DIVISION_SIM(DIVISION_SIM(data->simulationInfo->realParameter[181] /* gENROU.pm0 PARAM */ - ((data->simulationInfo->realParameter[105] /* gENROU.D PARAM */) * (data->localData[0]->realVars[7] /* gENROU.w STATE(1) */)),1.0 + data->localData[0]->realVars[7] /* gENROU.w STATE(1) */,"1.0 + gENROU.w",equationIndexes) - data->localData[0]->realVars[71] /* gENROU.Te variable */,data->simulationInfo->realParameter[111] /* gENROU.H PARAM */,"gENROU.H",equationIndexes));
  TRACE_POP
}
/*
equation index: 257
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_258(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[12] /* der(gENROU.Epd) STATE_DER */ = DIVISION_SIM((-data->localData[0]->realVars[73] /* gENROU.XaqIlq variable */),data->simulationInfo->realParameter[150] /* gENROU.Tpq0 PARAM */,"gENROU.Tpq0",equationIndexes);
  TRACE_POP
}
/*
equation index: 259
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_259(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp0;
  modelica_real tmp1;
  tmp0 = data->localData[0]->realVars[88] /* pwLine.is.im variable */;
  tmp1 = data->localData[0]->realVars[89] /* pwLine.is.re variable */;
  data->localData[0]->realVars[62] /* gENROU.I variable */ = sqrt((tmp0 * tmp0) + (tmp1 * tmp1));
  TRACE_POP
}
/*
equation index: 260
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_266(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[64] /* gENROU.PELEC variable */ = DIVISION_SIM(data->localData[0]->realVars[63] /* gENROU.P variable */,data->simulationInfo->realParameter[104] /* gENROU.CoB PARAM */,"gENROU.CoB",equationIndexes);
  TRACE_POP
}
/*
equation index: 267
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_268(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp2;
  modelica_real tmp3;
  tmp2 = data->localData[0]->realVars[91] /* pwLine.vs.re variable */;
  tmp3 = data->localData[0]->realVars[90] /* pwLine.vs.im variable */;
  data->localData[0]->realVars[125] /* sEXS.ECOMP variable */ = sqrt((tmp2 * tmp2) + (tmp3 * tmp3));
  TRACE_POP
}
/*
equation index: 269
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_271(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[18] /* der(sEXS.leadLag.TF.x_scaled[1]) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[274] /* sEXS.leadLag.TF.a_end PARAM */) * (data->localData[0]->realVars[127] /* sEXS.V_erro.y variable */) - ((data->simulationInfo->realParameter[273] /* sEXS.leadLag.TF.a[2] PARAM */) * (data->localData[0]->realVars[8] /* sEXS.leadLag.TF.x_scaled[1] STATE(1) */)),data->simulationInfo->realParameter[272] /* sEXS.leadLag.TF.a[1] PARAM */,"sEXS.leadLag.TF.a[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 272
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_272(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[130] /* sEXS.leadLag.TF.y variable */ = (data->simulationInfo->realParameter[278] /* sEXS.leadLag.TF.bb[2] PARAM */ - ((data->simulationInfo->realParameter[273] /* sEXS.leadLag.TF.a[2] PARAM */) * (data->simulationInfo->realParameter[279] /* sEXS.leadLag.TF.d PARAM */))) * (data->localData[0]->realVars[129] /* sEXS.leadLag.TF.x[1] variable */) + (data->simulationInfo->realParameter[279] /* sEXS.leadLag.TF.d PARAM */) * (data->localData[0]->realVars[127] /* sEXS.V_erro.y variable */);
  TRACE_POP
}
/*
equation index: 273
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_273(DATA *data, threadData_t *threadData)
{
  ...
  tmp4 = Less(fabs(data->simulationInfo->realParameter[269] /* sEXS.leadLag.T1 PARAM */ - data->simulationInfo->realParameter[270] /* sEXS.leadLag.T2 PARAM */),1e-15);
  data->localData[0]->realVars[131] /* sEXS.leadLag.y variable */ = (tmp4?(data->simulationInfo->realParameter[268] /* sEXS.leadLag.K PARAM */) * (data->localData[0]->realVars[127] /* sEXS.V_erro.y variable */):data->localData[0]->realVars[130] /* sEXS.leadLag.TF.y variable */);
  TRACE_POP
}
/*
equation index: 274
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_274(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[19] /* der(sEXS.simpleLagLim.state) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[286] /* sEXS.simpleLagLim.K PARAM */) * (data->localData[0]->realVars[131] /* sEXS.leadLag.y variable */) - data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */,data->simulationInfo->realParameter[288] /* sEXS.simpleLagLim.T_mod PARAM */,"sEXS.simpleLagLim.T_mod",equationIndexes);
  TRACE_POP
}
/*
equation index: 275
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_276(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[13] /* der(gENROU.Epq) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[61] /* gENROU.EFD variable */ - data->localData[0]->realVars[72] /* gENROU.XADIFD variable */,data->simulationInfo->realParameter[147] /* gENROU.Tpd0 PARAM */,"gENROU.Tpd0",equationIndexes);
  TRACE_POP
}
/*
equation index: 277
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[290] /* sEXS.simpleLagLim.outMax PARAM */, 15, Greater);
  RELATIONHYSTERESIS(tmp7, (data->simulationInfo->realParameter[286] /* sEXS.simpleLagLim.K PARAM */) * (data->localData[0]->realVars[131] /* sEXS.leadLag.y variable */) - data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, 0.0, 16, Less);
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_278(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[291] /* sEXS.simpleLagLim.outMin PARAM */, 17, Less);
  RELATIONHYSTERESIS(tmp9, (data->simulationInfo->realParameter[286] /* sEXS.simpleLagLim.K PARAM */) * (data->localData[0]->realVars[131] /* sEXS.leadLag.y variable */) - data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, 0.0, 18, Greater);
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_279(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[30] /* GEN1.V variable */ = data->localData[0]->realVars[125] /* sEXS.ECOMP variable */;
  TRACE_POP
}
/*
equation index: 280
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_288(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp10;
  modelica_real tmp11;
  tmp10 = data->localData[0]->realVars[113] /* pwLine3.vr.re variable */;
  tmp11 = data->localData[0]->realVars[112] /* pwLine3.vr.im variable */;
  data->localData[0]->realVars[26] /* FAULT.V variable */ = sqrt((tmp10 * tmp10) + (tmp11 * tmp11));
  TRACE_POP
}
/*
equation index: 289
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_301(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_302(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_303(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_304(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_305(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  {
    data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[290] /* sEXS.simpleLagLim.outMax PARAM */;
  ...
  {
    data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[291] /* sEXS.simpleLagLim.outMin PARAM */;
    infoStreamPrint(LOG_EVENTS, 0, "reinit sEXS.simpleLagLim.state = %g", data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{cb250112-02f9-4d47-981c-133603ef4ca9}";
  ...
  data->modelData->nVariablesReal = 132;
  data->modelData->nDiscreteReal = 0;
  data->modelData->nVariablesInteger = 0;
  data->modelData->nVariablesBoolean = 2;
  data->modelData->nVariablesString = 0;
  data->modelData->nParametersReal = 296;
  ...
  data->modelData->modelDataXml.nEquations = 545;
