...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_172(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[61] /* eSDC1A.EFD0 variable */ = data->simulationInfo->realParameter[270] /* gENROE.efd0 PARAM */;
  TRACE_POP
}
/*
equation index: 173
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_175(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[93] /* gENROE.PSIppd variable */ = (data->localData[0]->realVars[8] /* gENROE.Epq STATE(1) */) * (data->simulationInfo->realParameter[218] /* gENROE.K3d PARAM */) + (data->localData[0]->realVars[9] /* gENROE.PSIkd STATE(1) */) * (data->simulationInfo->realParameter[220] /* gENROE.K4d PARAM */);
  TRACE_POP
}
/*
equation index: 176
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_176(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[94] /* gENROE.PSIppq variable */ = (data->localData[0]->realVars[10] /* gENROE.PSIkq STATE(1) */) * (data->simulationInfo->realParameter[221] /* gENROE.K4q PARAM */) + (data->localData[0]->realVars[7] /* gENROE.Epd STATE(1) */) * (data->simulationInfo->realParameter[219] /* gENROE.K3q PARAM */);
  TRACE_POP
}
/*
equation index: 177
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_178(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[29] /* $cse5 variable */ = omc_OpenIPSL_NonElectrical_Functions_SE__exp(threadData, data->localData[0]->realVars[92] /* gENROE.PSIpp variable */, data->simulationInfo->realParameter[240] /* gENROE.S10 PARAM */, data->simulationInfo->realParameter[241] /* gENROE.S12 PARAM */, 1.0, 1.2);
  TRACE_POP
}
/*
equation index: 179
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_179(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[24] /* der(gENROE.delta) STATE_DER */ = (data->simulationInfo->realParameter[284] /* gENROE.w_b PARAM */) * (data->localData[0]->realVars[12] /* gENROE.w STATE(1) */);
  TRACE_POP
}
/*
equation index: 180
type: SIMPLE_ASSIGN
eSDC1A.Vref_step.y = eSDC1A.Vref_step.offset + (if time < eSDC1A.Vref_step.startTime then 0.0 else eSDC1A.Vref_step.height)
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_180(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->timeValue, data->simulationInfo->realParameter[117] /* eSDC1A.Vref_step.startTime PARAM */, 0, Less);
  data->localData[0]->realVars[62] /* eSDC1A.Vref_step.y variable */ = data->simulationInfo->realParameter[116] /* eSDC1A.Vref_step.offset PARAM */ + (tmp2?0.0:data->simulationInfo->realParameter[115] /* eSDC1A.Vref_step.height PARAM */);
  TRACE_POP
}
/*
equation index: 181
type: SIMPLE_ASSIGN
eSDC1A.DiffV.u1 = eSDC1A.add7.k1 * eSDC1A.Vref_step.y + eSDC1A.add7.k2 * eSDC1A.VoltageReference.k
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_181(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,181};
  data->localData[0]->realVars[56] /* eSDC1A.DiffV.u1 variable */ = (data->simulationInfo->realParameter[121] /* eSDC1A.add7.k1 PARAM */) * (data->localData[0]->realVars[62] /* eSDC1A.Vref_step.y variable */) + (data->simulationInfo->realParameter[122] /* eSDC1A.add7.k2 PARAM */) * (data->simulationInfo->realParameter[113] /* eSDC1A.VoltageReference.k PARAM */);
  TRACE_POP
}
/*
equation index: 182
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_184(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[68] /* eSDC1A.imLeadLag.TF.x[1] variable */ = DIVISION_SIM(data->localData[0]->realVars[2] /* eSDC1A.imLeadLag.TF.x_scaled[1] STATE(1) */,data->simulationInfo->realParameter[136] /* eSDC1A.imLeadLag.TF.a_end PARAM */,"eSDC1A.imLeadLag.TF.a_end",equationIndexes);
  TRACE_POP
}
/*
equation index: 185
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_185(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[72] /* eSDC1A.rotatingExciterLimited.Sum.u2 variable */ = (data->simulationInfo->realParameter[157] /* eSDC1A.rotatingExciterLimited.gain.k PARAM */) * (data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */);
  TRACE_POP
}
/*
equation index: 186
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_186(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[74] /* eSDC1A.rotatingExciterLimited.VE.u2 variable */ = omc_OpenIPSL_NonElectrical_Functions_SE(threadData, data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[164] /* eSDC1A.rotatingExciterLimited.se1.SE1 PARAM */, data->simulationInfo->realParameter[165] /* eSDC1A.rotatingExciterLimited.se1.SE2 PARAM */, data->simulationInfo->realParameter[162] /* eSDC1A.rotatingExciterLimited.se1.E1 PARAM */, data->simulationInfo->realParameter[163] /* eSDC1A.rotatingExciterLimited.se1.E2 PARAM */);
  TRACE_POP
}
/*
equation index: 187
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_187(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[71] /* eSDC1A.rotatingExciterLimited.Sum.u1 variable */ = (data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */) * (data->localData[0]->realVars[74] /* eSDC1A.rotatingExciterLimited.VE.u2 variable */);
  TRACE_POP
}
/*
equation index: 188
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_188(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.Sum.y variable */ = (data->simulationInfo->realParameter[154] /* eSDC1A.rotatingExciterLimited.Sum.k1 PARAM */) * (data->localData[0]->realVars[71] /* eSDC1A.rotatingExciterLimited.Sum.u1 variable */) + (data->simulationInfo->realParameter[155] /* eSDC1A.rotatingExciterLimited.Sum.k2 PARAM */) * (data->localData[0]->realVars[72] /* eSDC1A.rotatingExciterLimited.Sum.u2 variable */);
  TRACE_POP
}
/*
equation index: 189
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_237(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_236(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_235(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_234(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_233(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_232(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_231(DATA*, threadData_t*);
...
vars: {pwLine3.ir.re, pwLine4.is.re, pwLine3.ir.im, pwLine4.is.im, pwLine1.is.im, pwLine3.is.im, constantLoad.p.ir, pwLine3.is.re, pwLine.ir.re, pwLine.ir.im, pwLine1.ir.re, pwLine1.ir.im, gENCLS.iq, gENCLS.id, pwLine1.vr.im, pwLine1.vr.re, gENROE.id, gENROE.iq, pwLine1.vs.re, pwLine1.vs.im, pwLine3.vr.im, pwLine3.vr.re}
eqns: {193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215, 237, 236, 235, 234, 233, 232, 231, 230, 229, 228, 227, 226, 225, 224, 223, 222, 221, 220, 219, 218, 217, 216}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_283(DATA *data, threadData_t *threadData)
{
  ...
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 283 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[2] = data->localData[0]->realVars[133] /* pwLine3.ir.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[3] = data->localData[0]->realVars[145] /* pwLine4.is.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[4] = data->localData[0]->realVars[123] /* pwLine1.is.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[5] = data->localData[0]->realVars[135] /* pwLine3.is.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[6] = data->localData[0]->realVars[54] /* constantLoad.p.ir variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[7] = data->localData[0]->realVars[136] /* pwLine3.is.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[8] = data->localData[0]->realVars[112] /* pwLine.ir.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[9] = data->localData[0]->realVars[111] /* pwLine.ir.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[10] = data->localData[0]->realVars[122] /* pwLine1.ir.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[11] = data->localData[0]->realVars[121] /* pwLine1.ir.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[12] = data->localData[0]->realVars[82] /* gENCLS.iq variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[13] = data->localData[0]->realVars[81] /* gENCLS.id variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[14] = data->localData[0]->realVars[125] /* pwLine1.vr.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[15] = data->localData[0]->realVars[126] /* pwLine1.vr.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[16] = data->localData[0]->realVars[101] /* gENROE.id variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[17] = data->localData[0]->realVars[102] /* gENROE.iq variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[18] = data->localData[0]->realVars[128] /* pwLine1.vs.re variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[19] = data->localData[0]->realVars[127] /* pwLine1.vs.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[20] = data->localData[0]->realVars[137] /* pwLine3.vr.im variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[21] = data->localData[0]->realVars[138] /* pwLine3.vr.re variable */;
  retValue = solve_nonlinear_system(data, threadData, 1);
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,283};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 283 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
  ...
  data->localData[0]->realVars[133] /* pwLine3.ir.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[2];
  data->localData[0]->realVars[145] /* pwLine4.is.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[3];
  data->localData[0]->realVars[123] /* pwLine1.is.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[4];
  data->localData[0]->realVars[135] /* pwLine3.is.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[5];
  data->localData[0]->realVars[54] /* constantLoad.p.ir variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[6];
  data->localData[0]->realVars[136] /* pwLine3.is.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[7];
  data->localData[0]->realVars[112] /* pwLine.ir.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[8];
  data->localData[0]->realVars[111] /* pwLine.ir.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[9];
  data->localData[0]->realVars[122] /* pwLine1.ir.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[10];
  data->localData[0]->realVars[121] /* pwLine1.ir.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[11];
  data->localData[0]->realVars[82] /* gENCLS.iq variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[12];
  data->localData[0]->realVars[81] /* gENCLS.id variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[13];
  data->localData[0]->realVars[125] /* pwLine1.vr.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[14];
  data->localData[0]->realVars[126] /* pwLine1.vr.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[15];
  data->localData[0]->realVars[101] /* gENROE.id variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[16];
  data->localData[0]->realVars[102] /* gENROE.iq variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[17];
  data->localData[0]->realVars[128] /* pwLine1.vs.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[18];
  data->localData[0]->realVars[127] /* pwLine1.vs.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[19];
  data->localData[0]->realVars[137] /* pwLine3.vr.im variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[20];
  data->localData[0]->realVars[138] /* pwLine3.vr.re variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[21];
  TRACE_POP
}
/*
equation index: 284
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_285(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[60] /* eSDC1A.ECOMP variable */ = sqrt((tmp0 * tmp0) + (tmp1 * tmp1));
  TRACE_POP
}
/*
equation index: 286
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_287(DATA *data, threadData_t *threadData)
{
  ...
  modelica_boolean tmp2;
  tmp2 = LessEq(fabs(data->simulationInfo->realParameter[100] /* eSDC1A.TransducerDelay.T PARAM */),1e-15);
  data->localData[0]->realVars[57] /* eSDC1A.DiffV.u2 variable */ = (tmp2?(data->localData[0]->realVars[60] /* eSDC1A.ECOMP variable */) * (data->simulationInfo->realParameter[99] /* eSDC1A.TransducerDelay.K PARAM */):data->localData[0]->realVars[0] /* eSDC1A.TransducerDelay.state STATE(1) */);
  TRACE_POP
}
/*
equation index: 288
type: SIMPLE_ASSIGN
eSDC1A.DiffV.y = eSDC1A.DiffV.k1 * eSDC1A.DiffV.u1 + eSDC1A.DiffV.k2 * eSDC1A.DiffV.u2
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_288(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,288};
  data->localData[0]->realVars[58] /* eSDC1A.DiffV.y variable */ = (data->simulationInfo->realParameter[76] /* eSDC1A.DiffV.k1 PARAM */) * (data->localData[0]->realVars[56] /* eSDC1A.DiffV.u1 variable */) + (data->simulationInfo->realParameter[77] /* eSDC1A.DiffV.k2 PARAM */) * (data->localData[0]->realVars[57] /* eSDC1A.DiffV.u2 variable */);
  TRACE_POP
}
/*
equation index: 289
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_289(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[64] /* eSDC1A.add3_1.y variable */ = (data->simulationInfo->realParameter[118] /* eSDC1A.add3_1.k1 PARAM */) * (data->localData[0]->realVars[59] /* eSDC1A.DiffV1.y variable */) + (data->simulationInfo->realParameter[119] /* eSDC1A.add3_1.k2 PARAM */) * (data->localData[0]->realVars[58] /* eSDC1A.DiffV.y variable */) + (data->simulationInfo->realParameter[120] /* eSDC1A.add3_1.k3 PARAM */) * (data->localData[0]->realVars[67] /* eSDC1A.imDerivativeLag.y variable */);
  TRACE_POP
}
/*
equation index: 290
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_290(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[15] /* der(eSDC1A.imLeadLag.TF.x_scaled[1]) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[136] /* eSDC1A.imLeadLag.TF.a_end PARAM */) * (data->localData[0]->realVars[64] /* eSDC1A.add3_1.y variable */) - ((data->simulationInfo->realParameter[135] /* eSDC1A.imLeadLag.TF.a[2] PARAM */) * (data->localData[0]->realVars[2] /* eSDC1A.imLeadLag.TF.x_scaled[1] STATE(1) */)),data->simulationInfo->realParameter[134] /* eSDC1A.imLeadLag.TF.a[1] PARAM */,"eSDC1A.imLeadLag.TF.a[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 291
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_291(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[69] /* eSDC1A.imLeadLag.TF.y variable */ = (data->simulationInfo->realParameter[140] /* eSDC1A.imLeadLag.TF.bb[2] PARAM */ - ((data->simulationInfo->realParameter[135] /* eSDC1A.imLeadLag.TF.a[2] PARAM */) * (data->simulationInfo->realParameter[141] /* eSDC1A.imLeadLag.TF.d PARAM */))) * (data->localData[0]->realVars[68] /* eSDC1A.imLeadLag.TF.x[1] variable */) + (data->simulationInfo->realParameter[141] /* eSDC1A.imLeadLag.TF.d PARAM */) * (data->localData[0]->realVars[64] /* eSDC1A.add3_1.y variable */);
  TRACE_POP
}
/*
equation index: 292
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_292(DATA *data, threadData_t *threadData)
{
  ...
  tmp3 = Less(fabs(data->simulationInfo->realParameter[131] /* eSDC1A.imLeadLag.T1 PARAM */ - data->simulationInfo->realParameter[132] /* eSDC1A.imLeadLag.T2 PARAM */),1e-15);
  data->localData[0]->realVars[65] /* eSDC1A.hV_GATE.n1 variable */ = (tmp3?(data->simulationInfo->realParameter[130] /* eSDC1A.imLeadLag.K PARAM */) * (data->localData[0]->realVars[64] /* eSDC1A.add3_1.y variable */):data->localData[0]->realVars[69] /* eSDC1A.imLeadLag.TF.y variable */);
  TRACE_POP
}
/*
equation index: 293
type: SIMPLE_ASSIGN
eSDC1A.hV_GATE.p = if eSDC1A.hV_GATE.n1 < minusInf.k then minusInf.k else eSDC1A.hV_GATE.n1
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_293(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp4, data->localData[0]->realVars[65] /* eSDC1A.hV_GATE.n1 variable */, data->simulationInfo->realParameter[285] /* minusInf.k PARAM */, 15, Less);
  data->localData[0]->realVars[66] /* eSDC1A.hV_GATE.p variable */ = (tmp4?data->simulationInfo->realParameter[285] /* minusInf.k PARAM */:data->localData[0]->realVars[65] /* eSDC1A.hV_GATE.n1 variable */);
  TRACE_POP
}
/*
equation index: 294
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_295(DATA *data, threadData_t *threadData)
{
  ...
  tmp5 = LessEq(fabs(data->simulationInfo->realParameter[167] /* eSDC1A.simpleLagLim.T PARAM */),1e-15);
  data->localData[0]->realVars[70] /* eSDC1A.rotatingExciterLimited.I_C variable */ = (tmp5?fmax(fmin((data->localData[0]->realVars[66] /* eSDC1A.hV_GATE.p variable */) * (data->simulationInfo->realParameter[166] /* eSDC1A.simpleLagLim.K PARAM */),data->simulationInfo->realParameter[170] /* eSDC1A.simpleLagLim.outMax PARAM */),data->simulationInfo->realParameter[171] /* eSDC1A.simpleLagLim.outMin PARAM */):fmax(fmin(data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */,data->simulationInfo->realParameter[170] /* eSDC1A.simpleLagLim.outMax PARAM */),data->simulationInfo->realParameter[171] /* eSDC1A.simpleLagLim.outMin PARAM */));
  TRACE_POP
}
/*
equation index: 296
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_296(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[75] /* eSDC1A.rotatingExciterLimited.feedback.y variable */ = data->localData[0]->realVars[70] /* eSDC1A.rotatingExciterLimited.I_C variable */ - data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.Sum.y variable */;
  TRACE_POP
}
/*
equation index: 297
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_297(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[160] /* eSDC1A.rotatingExciterLimited.sISO.outMin PARAM */, 16, Less);
  RELATIONHYSTERESIS(tmp7, (data->simulationInfo->realParameter[158] /* eSDC1A.rotatingExciterLimited.sISO.k PARAM */) * (data->localData[0]->realVars[75] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, 17, Less);
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[159] /* eSDC1A.rotatingExciterLimited.sISO.outMax PARAM */, 18, Greater);
  RELATIONHYSTERESIS(tmp9, (data->simulationInfo->realParameter[158] /* eSDC1A.rotatingExciterLimited.sISO.k PARAM */) * (data->localData[0]->realVars[75] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, 19, Greater);
  data->localData[0]->realVars[16] /* der(eSDC1A.rotatingExciterLimited.sISO.y) STATE_DER */ = (((tmp6 && tmp7) || (tmp8 && tmp9))?0.0:(data->simulationInfo->realParameter[158] /* eSDC1A.rotatingExciterLimited.sISO.k PARAM */) * (data->localData[0]->realVars[75] /* eSDC1A.rotatingExciterLimited.feedback.y variable */));
  TRACE_POP
}
/*
equation index: 298
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_298(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[170] /* eSDC1A.simpleLagLim.outMax PARAM */, 20, Greater);
  RELATIONHYSTERESIS(tmp11, (data->simulationInfo->realParameter[166] /* eSDC1A.simpleLagLim.K PARAM */) * (data->localData[0]->realVars[66] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, 21, Less);
  data->localData[0]->booleanVars[1] /* $whenCondition2 DISCRETE */ = (tmp10 && tmp11);
  TRACE_POP
}
/*
equation index: 299
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_299(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp12, data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[171] /* eSDC1A.simpleLagLim.outMin PARAM */, 22, Less);
  RELATIONHYSTERESIS(tmp13, (data->simulationInfo->realParameter[166] /* eSDC1A.simpleLagLim.K PARAM */) * (data->localData[0]->realVars[66] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, 23, Greater);
  data->localData[0]->booleanVars[0] /* $whenCondition1 DISCRETE */ = (tmp12 && tmp13);
  TRACE_POP
}
/*
equation index: 300
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_300(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[36] /* GEN1.V variable */ = data->localData[0]->realVars[60] /* eSDC1A.ECOMP variable */;
  TRACE_POP
}
/*
equation index: 301
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_304(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[63] /* eSDC1A.XADIFD variable */ = (data->simulationInfo->realParameter[214] /* gENROE.K1d PARAM */) * (data->localData[0]->realVars[8] /* gENROE.Epq STATE(1) */ + (data->simulationInfo->realParameter[251] /* gENROE.Xl PARAM */ - data->simulationInfo->realParameter[252] /* gENROE.Xpd PARAM */) * (data->localData[0]->realVars[101] /* gENROE.id variable */) - data->localData[0]->realVars[9] /* gENROE.PSIkd STATE(1) */) + data->localData[0]->realVars[8] /* gENROE.Epq STATE(1) */ + (data->localData[0]->realVars[101] /* gENROE.id variable */) * (data->simulationInfo->realParameter[250] /* gENROE.Xd PARAM */ - data->simulationInfo->realParameter[252] /* gENROE.Xpd PARAM */) + (data->localData[0]->realVars[29] /* $cse5 variable */) * (data->localData[0]->realVars[93] /* gENROE.PSIppd variable */);
  TRACE_POP
}
/*
equation index: 305
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_305(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[21] /* der(gENROE.Epq) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */ - data->localData[0]->realVars[63] /* eSDC1A.XADIFD variable */,data->simulationInfo->realParameter[243] /* gENROE.Tpd0 PARAM */,"gENROE.Tpd0",equationIndexes);
  TRACE_POP
}
/*
equation index: 306
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_306(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[23] /* der(gENROE.PSIkq) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[7] /* gENROE.Epd STATE(1) */ + (data->simulationInfo->realParameter[256] /* gENROE.Xpq PARAM */ - data->simulationInfo->realParameter[251] /* gENROE.Xl PARAM */) * (data->localData[0]->realVars[102] /* gENROE.iq variable */) - data->localData[0]->realVars[10] /* gENROE.PSIkq STATE(1) */,data->simulationInfo->realParameter[245] /* gENROE.Tppq0 PARAM */,"gENROE.Tppq0",equationIndexes);
  TRACE_POP
}
/*
equation index: 307
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_308(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[20] /* der(gENROE.Epd) STATE_DER */ = DIVISION_SIM((-data->localData[0]->realVars[98] /* gENROE.XaqIlq variable */),data->simulationInfo->realParameter[246] /* gENROE.Tpq0 PARAM */,"gENROE.Tpq0",equationIndexes);
  TRACE_POP
}
/*
equation index: 309
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_310(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[25] /* der(gENROE.w) STATE_DER */ = (0.5) * (DIVISION_SIM(DIVISION_SIM(data->simulationInfo->realParameter[277] /* gENROE.pm0 PARAM */ - ((data->simulationInfo->realParameter[201] /* gENROE.D PARAM */) * (data->localData[0]->realVars[12] /* gENROE.w STATE(1) */)),1.0 + data->localData[0]->realVars[12] /* gENROE.w STATE(1) */,"1.0 + gENROE.w",equationIndexes) - data->localData[0]->realVars[97] /* gENROE.Te variable */,data->simulationInfo->realParameter[207] /* gENROE.H PARAM */,"gENROE.H",equationIndexes));
  TRACE_POP
}
/*
equation index: 311
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_311(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp14;
  modelica_real tmp15;
  tmp14 = data->localData[0]->realVars[113] /* pwLine.is.im variable */;
  tmp15 = data->localData[0]->realVars[114] /* pwLine.is.re variable */;
  data->localData[0]->realVars[88] /* gENROE.I variable */ = sqrt((tmp14 * tmp14) + (tmp15 * tmp15));
  TRACE_POP
}
/*
equation index: 312
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_314(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[90] /* gENROE.PELEC variable */ = DIVISION_SIM(data->localData[0]->realVars[89] /* gENROE.P variable */,data->simulationInfo->realParameter[200] /* gENROE.CoB PARAM */,"gENROE.CoB",equationIndexes);
  TRACE_POP
}
/*
equation index: 315
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_318(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp16;
  modelica_real tmp17;
  tmp16 = data->localData[0]->realVars[138] /* pwLine3.vr.re variable */;
  tmp17 = data->localData[0]->realVars[137] /* pwLine3.vr.im variable */;
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_327(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp18;
  modelica_real tmp19;
  tmp18 = data->localData[0]->realVars[126] /* pwLine1.vr.re variable */;
  tmp19 = data->localData[0]->realVars[125] /* pwLine1.vr.im variable */;
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_337(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_338(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_339(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_340(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_341(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_342(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_343(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  {
    data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[170] /* eSDC1A.simpleLagLim.outMax PARAM */;
  ...
  {
    data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[171] /* eSDC1A.simpleLagLim.outMin PARAM */;
    infoStreamPrint(LOG_EVENTS, 0, "reinit eSDC1A.simpleLagLim.state = %g", data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{fac48098-6cc4-4cc8-bc4f-c36ecb33c4e7}";
  ...
  data->modelData->nParametersReal = 337;
  ...
  data->modelData->modelDataXml.nEquations = 613;
