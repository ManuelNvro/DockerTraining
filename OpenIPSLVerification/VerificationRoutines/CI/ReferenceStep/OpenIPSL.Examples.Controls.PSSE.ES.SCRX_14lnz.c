...
extern "C" {
#endif
const char *OpenIPSL_Examples_Controls_PSSE_ES_SCRX_linear_model_frame()
{
  return "model linearized_model \"OpenIPSL_Examples_Controls_PSSE_ES_SCRX\" \n  parameter Integer n = 10 \"number of states\";\n  parameter Integer m = 0 \"number of inputs\";\n  parameter Integer p = 0 \"number of outputs\";\n"
